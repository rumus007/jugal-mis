...
<div> 
  ...
  <div class="chart-wrapper flex">
    <house-chart
      ...
      :tableTitle="'वडागत रुपमा घरकाे संख्या'"
    ...
    <house-chart
      ...
      :tableTitle="'घरसम्म पुग्ने बाटाेकाे प्रकृति'"
    ...
    <house-chart
      ...
      :tableTitle="'घरसम्म पुुग्ने बाटाेकाे प्रकार'"
    ...
    <house-chart
      ...
      :tableTitle="'घर नम्बर भएकाे वा नभएकाे'"
    ...
    <house-chart
      ...
      :tableTitle="'घरनक्सा पास (अभिलेखिकरण)'"
