<template>
  <main>
    ...
    <section class="info-cards-section">
      <div class="container">
        <div class="info-cards-section__container">
          <div class="card">
            <div class="card__title">१०</div>
            <div class="card__desc">घरपरिवारकाे कूल संख्या</div>
          </div>
          <div class="card">
            <div class="card__title">२००</div>
            <div class="card__desc">कूल जनसंख्या</div>
          </div>
          <div class="card">
            <div class="card__title">५%</div>
            <div class="card__desc">युवाकाे प्रतिशत</div>
          </div>
          <div class="card">
            <div class="card__title">३०%</div>
            <div class="card__desc">राेजगार जनसंख्या</div>
          </div>
          <div class="card">
            <div class="card__title">८%</div>
